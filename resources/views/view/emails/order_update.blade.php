...
<html lang="{{ setting('localeCode', 'en') }}" dir="{{ setting('localeCode') == 'ar' ? 'rtl':'ltr' }}"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css" nonce="">
